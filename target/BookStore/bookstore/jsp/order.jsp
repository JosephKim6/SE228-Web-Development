...
<html lang="en">
  ...
  <body>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="#">Orders Table <span class="sr-only">(current)</span></a></li>
              ...
              <%
                for (int i = 0; i < orderList.size(); i++) {
                  ...
                  while(iterator.hasNext()){
                    ...
                    orderitemStr += item.getId() + ": " + bookName + " " + item.getAmount() + " copy " +
    ...
    <script type="text/javascript" charset="utf8" src="<%=path%>/bookstore/js/order.js"></script>
