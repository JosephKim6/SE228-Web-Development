...
<div class="container">
    ...
    <form class="form-signin" id="signin" target="id_iframe">
        ...
        <br>
        <button class="btn btn-lg btn-primary btn-block" id="submitButton">Sign in</button>
    </form>
...
<script src="<%=path%>/bookstore/js/signin.js"></script>
